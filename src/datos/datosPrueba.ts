...
export const mockEvents: EventoAcademico[] = [
  {
    id: 'evt-001',
    title: 'Congreso Internacional de Innovacion Educativa',
    eventType: 'congreso',
    description: 'Encuentro academico sobre investigacion, docencia y transformacion digital.',
  ...
  {
    id: 'evt-002',
    title: 'Taller de Metodologias de Investigacion',
    eventType: 'taller',
    description: 'Sesion practica para formulacion de proyectos y analisis de datos.',
  ...
  {
    id: 'evt-003',
    title: 'Seminario de Etica en Inteligencia Artificial',
    eventType: 'seminario',
    description: 'Conferencias breves y mesa de discusion con docentes invitados.',
    location: 'Salon de Postgrado',
...
export const mockInscripcions: Inscripcion[] = [
  {
    id: 'reg-001',
    eventId: 'evt-001',
...
export const mockAttendance: RegistroAsistencia[] = [
  {
    id: 'att-001',
    eventId: 'evt-002',
