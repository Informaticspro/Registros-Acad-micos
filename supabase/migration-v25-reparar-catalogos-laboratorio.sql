-- Reparacion de una instalacion que omitio v13. No modifica equipos ni bitacoras.
begin;
...
grant select, insert, update, delete on public.laboratory_catalogs to authenticated;
revoke all on public.laboratory_catalogs from anon;
